...
class ComplianceLevelManager:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        if config_path and config_path.exists():
            ...
            logger.warning(
                "No compliance-levels.json found, using permissive validation"
            )
    ...
    def _load_config(self, config_path: Path):
        ...
        try:
            ...
            logger.info(
                f"Loaded {len(self.levels)} compliance levels from {config_path}"
            )
    ...
    def validate_compliance_level(
        self, level_name: Optional[str], context: str = ""
    ) -> Optional[str]:
    ...
    def is_accessible(
        self, user_level: Optional[str], resource_level: Optional[str]
    ) -> bool:
